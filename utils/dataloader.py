...
class DataLoader:
    ...
    def _random_frames(self):
        ...
        frames = [os.path.join(video, '{}.png'.format(i)) for i in range(len(os.listdir(video)) / 2)]
        frames_fgbg = [os.path.join(video, '{}_fgbg.png'.format(i)) for i in range(len(os.listdir(video)) / 2)]
